...
<h2><?php echo __('Friend'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($friend['Friend']['user1']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('User2'); ?></dt>
		<dd>
			<?php echo h($friend['Friend']['user2']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Datemade'); ?></dt>
		<dd>
			<?php echo h($friend['Friend']['datemade']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Accepted'); ?></dt>
		<dd>
			<?php echo h($friend['Friend']['accepted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Friend'), array('action' => 'delete', $friend['Friend']['id']), array(), __('Are you sure you want to delete # %s?', $friend['Friend']['id'])); ?> </li>
