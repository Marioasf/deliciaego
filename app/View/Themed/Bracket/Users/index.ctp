                  ...
                  <div class="media-body">
                    ...
                    <ul class="social-list">
                     ...
                     for($j=0;$j<count($friends);$j++){//percorre array de amigos
  	                   if($users[$i]['User']['username']===$friends[$j]['Friend']['user2'])//verificar se é amigo, coloca botão Amigos
                        { 
                          $friends[$j]['Friend']['user2']=NULL;
                          echo '<button class="btn btn-sm btn-primary mr5"><i class="fa fa-check"></i> Amigos</button>';
  	                   	}
  	                   else//senão coloca botão para adicionar amigos
                         {
